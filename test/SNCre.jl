...
#=  evaluate the flexible panel model with serial correlated error  =#
opt = sfopt(warmstart_solver=(), main_solver=NewtonTrustRegion())
startpt = sfinit([0.5227960098102571,        # coefficient of explanatory variables
                  ...
                  0.])                       # coeffieciet of serial correlated ter
model = sfmodel_fit(
    sfspec(
        SNCre, useData(df),
